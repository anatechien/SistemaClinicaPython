...
class TelaPaciente(TelaAbstrata):
  ...
  def pega_responsavel(self):
    return self.le_texto("Nome do responsável legal: ")
  ...
  def pega_dados_paciente(self, cpf_disponivel=None):
    ...
    data_nascimento, responsavel = self.le_data_nascimento_com_responsavel()
    return {
      "nome": nome,
      "celular": celular,
      "cpf": cpf,
  ...
  def mostra_paciente(self, dados_paciente):
    ...
    if dados_paciente.get("responsavel"):
      print("RESPONSÁVEL: ", dados_paciente["responsavel"])
    print("\n")
